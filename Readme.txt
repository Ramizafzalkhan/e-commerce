...
@media screen and (max-width: 769px) and (min-width: 992px) {
/ Css will goes here /
}
...
@media screen and (max-width: 360px) and (min-width: 480px) {
 .classynav_mobile > ul > li > a {

  background-color: #4b6088 !important;
...
<body>
    ...
    <!-- ##### Header Area Start ##### -->
    <header class="header-area mobile_header">
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="croseNav">
                        ...
                        <!-- Menu -->
                        <div class="classy-menu classynav_mobile">
                  ...
                  <li><a href="#">Loans / Advance </a>
                                        <div class="megamenu">
                                           ...
                                           <li> <p class="text-nav">Installment Loan</p> </li>
                         ...
                         <li><a href="installment-loans-faq.php">FAQs</a></li>
                                            ...
                                            <ul class="single-mega cn-col-4">
                                            <li> <p class="text-nav">Payday/Advance Loan</p> </li>
                        ...
                        <li><a href="cash-advance-pricing.php">Pricing</a></li>
                                                ...
                                                <li><a href="#">Payment Calculator</a></li>
                                                 ...
                                                 <ul class="single-mega cn-col-4">
                                                 <li> <p class="text-nav">Mortage Finance</p> </li>
                                                 <li><a href="applicationform.php">Apply Now</a></li>
                                                <!--<li><a href="#">Payment Calculator</a></li>-->
                     ...
                     <li><a href="#"> Exchange & Transfer </a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="Rapid X.php">Rapid X </a></li>
                                            <li><a href="MoneyOrder.php">Money Order</a></li>
                  ...
                  <li><a href="cheque-cashing.php"> Cheque Cashing </a></li>
                                  <li><a href="goldandsilver.php"> Gold & Silver </a></li>
                      ...
                      <li><a href="#">Consumer Education</a></li> -->
                                    ...
                                    <li><a href="#"> Other Services</a>
                                        <ul class="dropdown wdth_css">
                                            <li><a href="taxfiling.php">Tax Filling</a></li>
                                            <li><a href="courierservice.php">Courier Services</a></li>
                                            <li><a href="callingcard.php">Calling Card</a></li>
                                            <li><a href="accountingandbookkeeping.php">Accounting & Book Keeping</a></li>
